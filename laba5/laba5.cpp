...
void cons() {
    ...
    const char* msg_for_help = "----------------------------------------\n"
        ...
        "x - вийти\n"
        "----------------------------------------";
    const char* msg_for_eng = "Введіть слово in english: ";
    const char* msg_for_ukr = "Введіть слово in ukrainian: ";
    const char* msg_for_count = "Введіть к-ть звернень до слова: ";
    const char* msg_for_translate = "Ваше слово in ukrainian: ";
